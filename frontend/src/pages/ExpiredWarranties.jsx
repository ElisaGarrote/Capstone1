...
// TableHeader component to render the table header (aligned with UpcomingEndOfLife)
...
// TableItem component to render each row (aligned with UpcomingEndOfLife)
...
export default function ExpiredWarranties() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        const apiPath = "/assets/reports/expired-warranty/?format=json";
        let resp;
        try {
          ...
          const fullUrl =
            assetsBase.replace(/\/$/, "") +
            "/reports/expired-warranty/?format=json";
        ...
        console.error("Failed to load expired warranties", err);
      }
    }
