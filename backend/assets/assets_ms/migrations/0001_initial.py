# Generated by Django 5.1.7 on 2025-09-15 08:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audit_date', models.DateField(default=datetime.date(2025, 9, 15))),
                ('next_audit_date', models.DateField(default=datetime.date(2025, 9, 15))),
                ('notes', models.TextField(blank=True, null=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(default=datetime.datetime(2025, 9, 15, 8, 42, 30, 559265, tzinfo=datetime.timezone.utc), editable=False)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(default=datetime.datetime(2025, 9, 15, 8, 42, 30, 558962, tzinfo=datetime.timezone.utc), editable=False)),
