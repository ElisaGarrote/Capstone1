# Generated by Django 5.1.7 on 2025-06-12 21:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audit_date', models.DateField(default=datetime.date(2025, 6, 12))),
                ('next_audit_date', models.DateField(default=datetime.date(2025, 6, 12))),
                ('notes', models.TextField(blank=True, null=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(default=datetime.datetime(2025, 6, 12, 21, 49, 57, 658665, tzinfo=datetime.timezone.utc), editable=False)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(default=datetime.datetime(2025, 6, 12, 21, 49, 57, 657653, tzinfo=datetime.timezone.utc), editable=False)),
